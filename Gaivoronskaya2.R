#Задание 2
#Выполнила Гайворонская О.В. ПАЭ 124
...
setwd("D:/Gaivoronskaya/mathmod2") 
getwd()
...
# Отфильтруем по заданию данные только за весенний период. С начала марта(59 день) по конец августа(151 день)
...
#Выведем графики
plot(mod1)
# Создадим модель добавив в неё значимые переменные из результатов функции anova()(со значимостью до 0.01, соответственно ***,** и * пометки)
